...
const RewardsCheckboxListForProfile = () => {
    ...
    if (completionPercentage === 0) {
        progressBarColor = "bg-salud-primary";
...
export default RewardsCheckboxListForProfile;
